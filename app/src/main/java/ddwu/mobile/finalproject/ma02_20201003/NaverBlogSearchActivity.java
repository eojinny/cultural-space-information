...
public class NaverBlogSearchActivity extends AppCompatActivity {
    ...
    ArrayAdapter<NaverBlogDto> adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<NaverBlogDto>(this, android.R.layout.simple_list_item_1, resultList);
    ...
    public void onClick(View v) {
        switch(v.getId()) {
            case R.id.btnSearch:
                if (!isOnline()) {
                    Toast.makeText(NaverBlogSearchActivity.this, "네트워크를 사용 설정해주세요.", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    class NaverAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDlg = ProgressDialog.show(NaverBlogSearchActivity.this, "Wait", "Downloading...");
        }
        ...
        protected void onPostExecute(String result) {
            ...
            ArrayList<NaverBlogDto> parserdList = parser.parse(result);

            if (parserdList == null || parserdList.size() == 0) {
                Toast.makeText(NaverBlogSearchActivity.this, "No data!", Toast.LENGTH_SHORT).show();
            } else {
                resultList.clear();
